...
const FIVEWAYS_MAP = [
  ...
  { match: ['RDAB', 'ABCS', 'CHEESE HI MELT U.S.A BURGER', 'CHEESE YELLOW PROCESS AMERICAN'], cell: 'F8', convert: p => r2(p / 2.27), note: 'Hi Melt American Burger /kg (RDAB, ÷ 2.27 kg; ABCS legacy)' },
